...
<?php
          ...
          $sql = "SELECT * FROM work where employee_id =$userid";
                            ...
                            ?>
                                    <tr>
                                        ...
                                        ?>
                                         ...
                                         <td>
                                              <a  href="work_distribution_done.php?appid=<?=$user['id']?>" class="btn btn-success btn-sm">
                                                <i class="fa fa-check"> </i>Done
                                            </a>
                                            <a  href="work_distribution_decline.php?appid=<?=$user['id']?>" class="btn btn-danger btn-sm">
                                                <i class="fa fa-check"> </i>Not Done
                                            </a>
                                         </td>
