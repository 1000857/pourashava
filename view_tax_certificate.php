...
<div style="width:944px; height:990px; padding:55px; TEXT-ALIGN: justify; border: 5px solid #787878">
       ...
       <span style="font-size:20px; font-weight:bold; margin-left:282px;">
        <span style="font-size:20px; font-weight:bold; margin-left:-20px;">VALUE ADDED TAX CERTIFICATE</span><br/><br/>
       </span>
       ...
       <span style="font-size:20px"; text-align:left; >BIN: 
         <?php
...
<br/>
<span style="font-size:20px"; text-align:left; >e-TIN: 
         <?php
         $number =  random_int(100000000000000, 100000000000000000);
echo $number;
?>
<br/>
 <span style="font-size:20px"; text-align:left; >Address: <?= $service['address']?>,<?= $service['upazilla']?>, <?= $service['district']?></span>
<br/>
...
<span style="font-size:20px"; text-align:left; >NATIONALITY: BANGLADESHI</span>
<br/>
<span style="font-size:20px"; text-align:left; >PROPERTY TYPE: <?= $service['type']?></span>
<br/>
<span style="font-size:20px"; text-align:left; >ISSUE DATE: 10/10/21</span>
<br/>
...
<br/><br/><br/><br/><br/>
     <span style="font-size:15px; font-style: italic;">SIGN OF UP SECRETARY</span>
       ...
       elseif ($service['type'] == 'industry') { ?><br>
       <span style="font-size:20px"; text-align:left; >BIN: 
         <?php
         $number =  random_int(100000000000000, 100000000000000000);
echo $number;
...
<br/><br/><br/><br/><br/>
     <span style="font-size:15px; font-style: italic;">SIGN OF UP SECRETARY</span>
       <span style="font-size:15px; margin-left:400px; font-style: italic;">SIGN OF MAYOR</span>
       <?php }
       elseif ($service['type'] == 'business') { ?><br>
       <span style="font-size:20px"; text-align:left; >BIN: 
         <?php
         $number =  random_int(100000000000000, 100000000000000000);
echo $number;
