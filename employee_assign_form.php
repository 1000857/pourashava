                    ...
                    <form action="employee_work_confirm.php" method="POST">
                        ...
                        <div class="card-header">
                            <strong class="card-title">
                                ...
                                <label><?= $complain['description'] ?> <span class="required"></span></label> <br>
                                <label>BUDGET:<span class="required">*</span></label>
                                <input type="number" name="amount" class="field-long" min="0" placeholder="Insert Amount"/></br>
                            </strong>
                        </div>
                        <div class="card-body text-center">
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    <td><?= $serial++ ?></td>
                                    <td>
                                        <input type="checkbox" id="allowance" name="work[]"
                                               value=" <?= $service['id'] ?> "></br>Assign<br>
                                    </td>
                                    <td><img style="height:90px" src="images/employee/<?= $service['Pic'] ?>" alt="">
                                    </td>
